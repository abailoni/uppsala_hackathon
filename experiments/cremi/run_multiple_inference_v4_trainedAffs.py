...
list_of_args = [
    ...
    (["--update0", "--config.model.model_kwargs.loadfrom", "--update2"
      # "--config.model.model_kwargs.path_backbone"
        ...
        "v4_trainAffsFromPatches.yml///v4_main",
    ],[
        ...
        "RUNS__HOME/v2_main_trainAffs/checkpoint.pytorch",
    ], [
        # "empty_config.yml",
        # "empty_config.yml",
        # "v4_submission.yml",
...
#         "v4_main.yml",
#       ]),
#     (["--update0", "--config.model.model_kwargs.loadfrom"
#       # "--config.model.model_kwargs.path_backbone"
#       ], [
#         "v4_onlyTrainGlia.yml///v4_onlyTrainGlia",
...
#     ],
#      ),
#     (["--config.name_experiment"], ["v4_onlyTrainGlia"]),
